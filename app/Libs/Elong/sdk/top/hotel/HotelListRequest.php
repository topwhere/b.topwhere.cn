...
class HotelListRequest{
    ...
    public function setPosition($Longitude,$Latitude,$Radius='2500')
    {
        $this->apiParas['Position']['Longitude'] = $Longitude;
        $this->apiParas['Position']['Latitude']  = $Latitude;
        $this->apiParas['Position']['Radius']    = $Radius;
    }
    public function setQueryType($QueryType)
    {
        $this->apiParas['QueryType'] = $QueryType;
    }
    public function setBusinessZoneId($BusinessId)
    {
