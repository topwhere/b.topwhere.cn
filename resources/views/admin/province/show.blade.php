    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="ProvinceName" lay-verify="title" value="{{$data->ProvinceName or ''}}" autocomplete="off" placeholder="请输入省份名" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script>
            layui.use(['form', 'table'], function(){
                ...
                form.on('submit(demo1)', function(data){
                    var id='{{$data->ProvinceId or 'create'}}';
                    $.ajax({
                        url:'{{url()->current()}}',
