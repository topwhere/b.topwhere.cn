    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="CityName" lay-verify="title" value="{{$data->CityName or ''}}" autocomplete="off" placeholder="请输入城市名" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script>
            layui.use(['form', 'table'], function(){
                ...
                form.on('submit(demo1)', function(data){
                    var id='{{$data->CityCode or 'create'}}';
                    $.ajax({
                        url:'{{url()->current()}}?province={{$_GET['province']}}',
