...
<style>.layui-table-tips-main,.layui-table-tips-main img{width: 300px;height: 300px;max-height:300px;margin: 0;padding:0;}</style>
    <a class="layui-btn layui-btn-primary add" href="javascript:show('{{url()->current()}}/0?city_id={{$city->CityCode}}')" >{{$city->CityName}}-添加商圈</a>
        ...
        function getdata() {
            layui.use('table', function(){
                ...
                table.render({
                    ...
                    ,method: 'post'
                    ,cols: [[
                        {field: 'businessId', title: 'ID', width: 50,sort:true}
                        ,{field: 'businessName', title: '城市名称', width: 130}
